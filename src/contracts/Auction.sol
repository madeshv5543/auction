...
contract Auction {
    ...
    constructor (address _owner, uint _bidIncrement, uint _startBlock, uint _endBlock, string _ipfsHash)  public  {
        require (_startBlock < _endBlock,"start block is greater than end block") ;
        require (_startBlock < block.number,"start block is less than end block") ;
        require (_owner != 0) ;
